...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "Hangarin Manager",
    "welcome_sign": "Welcome to Hangarin Task Manager",
    "copyright": "Hangarin",
    "show_ui_builder": True,
    "custom_css": "css/hide_recent.css",
}

# Make the admin super eye-friendly and easy to navigate!
JAZZMIN_UI_TWEAKS = {
    "theme": "litera",
